...
export interface IZeroswapFactoryInterface extends utils.Interface {
  functions: {
...
export interface IZeroswapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IZeroswapFactoryInterface;
