...
export interface ZeroswapFactoryInterface extends utils.Interface {
  functions: {
...
export interface ZeroswapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZeroswapFactoryInterface;
